...
export type ParsedCitation = { kbId: string; itemId: string; fileName: string; snippet: string; score: number }
export type ActiveCitation = { index: number; citation: ParsedCitation; top: number; left: number }
