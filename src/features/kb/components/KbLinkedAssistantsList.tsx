import type { KbLinkedAssistant } from "@/api/kb"

type KbLinkedAssistantsListProps = {
  assistants: KbLinkedAssistant[]
}

export function KbLinkedAssistantsList({ assistants }: KbLinkedAssistantsListProps) {
  return (
